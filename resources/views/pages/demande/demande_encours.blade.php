    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h2 class="card-title">LISTE DES DEMANDES EN COURS</h2>
                        <div class="m-3">
                            <button class="btn"><a href="{{ route('liste_demande') }}" class="btn btn-warning">Toutes les demandes</a></button>
                            ...
                            <button class="btn"><a href="{{ route('demande_encours') }}" class="btn btn-success">Demande en cours</a></button>
                        </div>
                                                ...
                                                <ul class="dropdown-menu">
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item " href="#">
                                                                <form action="{{ url('demande_inpute', [$list->id]) }}"
                                                                    method="post">
                                                                    @csrf
                                                                    <input type="text" name="statut" value="inputée"
                                                                        hidden>
                                                                    <button class="btn" type="submit">inputer</button>
                                                                </form>
                                                            </a>
                                                        </li>
