...
<div class="card">
    <div class="card-body">
      ...
      <!-- Vertical Form -->
      <form class="row g-3" action="{{route('gestion_jury.store')}}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="col-lg-12 mb-4">
            <div class="col-lg-12 mb-4">
                ...
                <input type="text" name="maitre_stage" class="form-control"  placeholder="">
              </div>
        </div>
        <div class="col-lg-12 mb-4">
          <label for="inputAddress" class="form-label">Directeur de Memoire</label>
          <input type="text" name="dm" class="form-control"  placeholder="">
        </div>
        <div class="col-lg-12 mb-4">
            <label for="inputAddress" class="form-label">Rapporteur</label>
            <input type="text" name="rapporteur" class="form-control"  placeholder="">
          </div>
