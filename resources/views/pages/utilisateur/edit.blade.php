    ...
    <section class="container-fluid">
        <div class="row p-3">
            <div class="col-lg-12 col-md-12">
                ...
                <form method="POST" action="{{ route('gestion_utilisateur.update', [$find->id]) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    <div class="row mb-3">
                        <div class="col-lg-6">
                            <label for="exampleInputEmail1" class="form-label">Nom</label>
                            <input type="text" name="nom" value="{{$find->nom}}" class="form-control" aria-describedby="emailHelp">
                        </div>
                        <div class="col-lg-6">
